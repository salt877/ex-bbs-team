...
import com.example.domain.Comment.SeparatedComment;
...
public class CommentRepository {
	 ...
	 */
	private static final RowMapper<Comment> COMMENT_RESULT_SET_EXTRACTOR = (rs, i) -> {
	...
	public List<Comment> findByArticleId(int articleId) {
		...
		List<Comment> commentList = jdbcTemplate.query(sql, param, COMMENT_RESULT_SET_EXTRACTOR);
		return commentList;
	}
